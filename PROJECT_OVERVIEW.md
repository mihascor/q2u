...
- **remark-* / rehype-* / rehype-prism-plus / rehype-katex / rehype-citation / rehype-katex-notranslate / rehype-preset-minify** — цепочка плагинов для обработки Markdown/MDX: таблицы, формулы, подсветка кода, сноски, минификация HTML.
